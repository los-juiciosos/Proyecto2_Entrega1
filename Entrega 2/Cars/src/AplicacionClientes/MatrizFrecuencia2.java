...
public class MatrizFrecuencia2 extends JPanel implements MetodosAuxiliares, ActionListener{
	...
	public MatrizFrecuencia2(AplicacionClientes aplicacionClientes) {	
...
//		System.out.println(carrosTotales);
	...
	public void contarVehiculos() {
		...
		Set<Entry<Object, Object>> entrySet = AplicacionClientes.cargaArchivos.cargarVehiculos().entrySet();
	...
	public void pintarCuadricula() {
		...
		Set<Entry<Object, Object>> entrySet = AplicacionClientes.cargaArchivos.cargarReserva().entrySet();
